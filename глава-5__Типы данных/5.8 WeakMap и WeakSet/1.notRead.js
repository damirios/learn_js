...
// Ответ: можно использовать WeakSet, т.к. он объект присутствует в WeakSet до тех пор, пока он доступен где-то ещё
// (в нашем случае в массиве сообщений messages)